...
#define SAMPLE_DEVICE_NAME          "NHOM_6"
...
#define CONFIG_SET_RAW_ADV_DATA 0
...
static const uint16_t TASK_1= 0xFF01;
...
static const uint8_t char1_name[]  = "Task_1";
...
static const uint8_t char_value[36] = {0x50, 0x6C, 0x65, 0x61, 0x73, 0x65, 0x20, 0x69, 0x6E, 
                                        0x70, 0x75, 0x74, 0x20, 0x49, 0x44, 0x20, 0x6F, 0x66, 
                                        0x20, 0x65, 0x61, 0x63, 0x68, 0x20, 0x74, 0x65, 0x61,
                                        0x6D, 0x20, 0x6D, 0x65, 0x6D, 0x62, 0x65, 0x72, 0x3A};
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    [IDX_CHAR_VAL_A] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&TASK_1, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE | ESP_GATT_PERM_READ_ENC_MITM,
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                ...
                if(gatt_db_handle_table[IDX_CHAR_VAL_A] == param->write.handle && param->write.len == 8) {
                    uint8_t write_data[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
                    if(memcmp(write_data, param->write.value, param->write.len) < 0) {
                        ESP_LOGI(EXAMPLE_TAG, "(3)***** Nhap ID thanh cong ***** \n");
                    }
                }
